...
class UserAgentParserTest {
    ...
    void classifiesMobile() {
        assertThat(UserAgentParser.device("Mozilla/5.0 (iPhone; CPU iPhone OS 17_0 like Mac OS X) "
                + "AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 Mobile/15E148 Safari/604.1"))
                .isEqualTo("mobile");
        assertThat(UserAgentParser.device("Mozilla/5.0 (Linux; Android 14; Pixel 8) "
    ...
    void classifiesTablet() {
        assertThat(UserAgentParser.device("Mozilla/5.0 (iPad; CPU OS 17_0 like Mac OS X) "
                + "AppleWebKit/605.1.15 Mobile Safari/604.1")).isEqualTo("tablet");
        assertThat(UserAgentParser.device("Mozilla/5.0 (Linux; Android 14; SM-X100) AppleWebKit/537.36 "
                + "(KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36 Tablet")).isEqualTo("tablet");
    }
    ...
    void classifiesBot() {
        assertThat(UserAgentParser.device("Googlebot/2.1 (+http://www.google.com/bot.html)"))
                .isEqualTo("bot");
        assertThat(UserAgentParser.device("Mozilla/5.0 (compatible; SemrushBot/7.0; +http://www.semrush.com/bot.html)"))
                .isEqualTo("bot");
    }
    ...
    void classifiesDesktopAndBlanks() {
        assertThat(UserAgentParser.device("Mozilla/5.0 (Windows NT 10.0; Win64; x64) "
