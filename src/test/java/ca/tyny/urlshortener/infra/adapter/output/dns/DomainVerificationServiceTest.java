...
class DomainVerificationServiceTest {
    ...
    void verify_promotesToActive() {
        ...
        DomainVerificationService service = new DomainVerificationService(repository,
                host -> List.of("url-shortener-verify=deadbeef", "other-record"), registry);
