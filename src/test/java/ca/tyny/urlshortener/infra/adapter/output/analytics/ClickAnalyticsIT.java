...
class ClickAnalyticsIT extends BaseIntegrationTest {
  ...
  void setUp() {
    ...
    mongoTemplate.insert(
        new ClickDailyDocument(
            ...
            Map.of(
                "device",
                Map.of("mobile", 3L, "desktop", 2L),
                "country",
                Map.of("BR", 4L, "(none)", 1L),
                "referrer",
                Map.of("https://ref_example_com", 3L, "(none)", 2L)),
            Instant.now()),
    ...
    mongoTemplate.insert(
        new ClickDailyDocument(
            ...
            Map.of(
                ...
                Map.of("US", 3L),
                "referrer",
                Map.of("https://other_ref", 2L, "(none)", 1L)),
            Instant.now()),
        MongoCollections.CLICK_DAILY);
    ...
    mongoTemplate.insert(
        new ClickEventDocument(
            linkCode, now, "UA-1", "203.0.113.1", "https://ref.example.com", "mobile", "BR"),
  ...
  void ownerReadsDailySeries() {
    ...
    @SuppressWarnings("unchecked")
    Map<String, Map<String, Number>> breakdown =
        (Map<String, Map<String, Number>>) resp.get("breakdown");
