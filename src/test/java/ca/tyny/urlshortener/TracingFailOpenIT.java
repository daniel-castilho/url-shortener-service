...
/**
 * Proves tracing is fail-open (Rule / observability spec): with the OTLP endpoint pointed at an
 * unreachable port and tracing fully enabled (sampling 1.0 so spans are actually produced), shorten
 * + redirect requests must still succeed. Span export failures happen asynchronously and never
