 ...
 *
 * <p>Proves that the URL validation rejects: - Private/internal IPs (RFC1918, loopback, link-local)
 * - Cloud metadata IPs (169.254.169.254) - URLs with user credentials - Invalid schemes (ftp, etc.)
 * - Invalid host formats
 *
 * <p>Allows valid public HTTPS URLs.
 */
