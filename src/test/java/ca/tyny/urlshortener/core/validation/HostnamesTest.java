...
class HostnamesTest {
  ...
  void validate_rejectsMalformed() {
    assertThatThrownBy(() -> Hostnames.validate("not a host"))
        .isInstanceOf(InvalidDomainException.class);
    assertThatThrownBy(() -> Hostnames.validate("")).isInstanceOf(InvalidDomainException.class);
    assertThatThrownBy(() -> Hostnames.validate("a..b")).isInstanceOf(InvalidDomainException.class);
