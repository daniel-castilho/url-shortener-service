...
class LinkUseCasesTest {
  ...
  @Mock private LinkQueryPort linkQueryPort;

  @Mock private LinkMutationPort linkMutationPort;

  @Mock private UrlCachePort urlCachePort;

  @Mock private UrlValidator urlValidator;

  @Mock private CustomDomainRepositoryPort customDomainRepository;
  ...
  void updateLinkChangesDestinationNotCode() {
    ...
    UpdateLinkUseCaseImpl impl =
        new UpdateLinkUseCaseImpl(
            linkQueryPort,
            mock(LinkMutationPort.class),
            mock(UrlCachePort.class),
            mock(UrlValidator.class),
            31536000L);

    UpdateLinkCommand cmd =
        new UpdateLinkCommand(
            "https://new-example.com", null, null, null, false, null, false, null, false);
  ...
  void updateLinkSetsDomain() {
    ...
    ShortUrl updated =
        updateLinkUseCase.update(
            ...
            LINK_ID,
            new UpdateLinkCommand(
                null, null, null, null, false, null, false, "links.example.com", true));
    ...
    assertThatThrownBy(
            () ->
                updateLinkUseCase.update(
                    ...
                    LINK_ID,
                    new UpdateLinkCommand(
                        "https://new.com", null, null, null, false, null, false, null, false)))
