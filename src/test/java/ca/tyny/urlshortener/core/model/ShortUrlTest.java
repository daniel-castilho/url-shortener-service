...
class ShortUrlTest {
  ...
  private ShortUrl base() {
    return new ShortUrl(
        ID, URL, LocalDateTime.now(), "user1", true, 0, null, null, null, null, null);
  }
  ...
  void expiresAtDefaultsToNull() {
    ...
    assertThat(
            new ShortUrl(ID, URL, LocalDateTime.now(), null, false, 0, null, null, null, null, null)
                .expiresAt())
        .isNull();
  }
  ...
  void withExpiresAtPreservesFields() {
    ...
    ShortUrl original =
        new ShortUrl(ID, URL, createdAt, "user1", true, 7, null, null, null, null, null);
