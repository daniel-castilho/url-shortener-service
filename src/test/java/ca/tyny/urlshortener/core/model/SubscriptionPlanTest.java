...
class SubscriptionPlanTest {
  ...
  void shouldValidateAliasLengthAgainstPlan() {
    ...
    assertThat(longAlias.length())
        .isGreaterThanOrEqualTo(SubscriptionPlan.FREE.getMinAliasLength());

    // Then - DIAMOND allows 3+ chars
    assertThat(shortAlias.length())
        .isGreaterThanOrEqualTo(SubscriptionPlan.DIAMOND.getMinAliasLength());
  }
