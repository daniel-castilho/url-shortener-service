...
class VanityUrlIdStrategyTest {
  ...
  void shouldThrowWhenUserIdIsNull() {
    assertThrows(IllegalArgumentException.class, () -> strategy.generateId("my-alias", null));
  }
  ...
  void shouldThrowWhenUserNotFound() {
    ...
    assertThrows(IllegalArgumentException.class, () -> strategy.generateId("my-alias", "user123"));
  }
  ...
  void shouldThrowWhenUserCannotCreateVanityUrls() {
    ...
    assertThrows(IllegalArgumentException.class, () -> strategy.generateId("my-alias", "user1"));
  }
  ...
  void shouldThrowWhenAliasFormatIsInvalid() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> strategy.generateId("invalid alias!", "user1"));
  }
  ...
  void shouldThrowWhenAliasAlreadyExists() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> strategy.generateId("existing-alias", "user1"));
  }
