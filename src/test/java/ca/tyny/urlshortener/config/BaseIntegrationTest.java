 ...
 *
 * No @DirtiesContext: it re-created the whole ApplicationContext per test method (114 contexts for
 * 114 tests), each opening its own Mongo connection pool and Redisson client. The shared mongod
