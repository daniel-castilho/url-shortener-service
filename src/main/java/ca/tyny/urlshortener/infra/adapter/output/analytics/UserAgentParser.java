 ...
 *
 * <p>Coarse bucketing is intentional: the values feed analytics breakdowns, not
 * UA sniffing. Covers common mobile/tablet markers, crawlers and a desktop
 * fallback.
 */
public final class UserAgentParser {
    ...
    /**
     * Classifies a raw User-Agent into the coarse device bucket
     * {@code desktop | mobile | tablet | bot}, or {@code null} when absent.
     */
    public static String device(String userAgent) {
        ...
        if (lower.contains("mobi") || lower.contains("iphone") || lower.contains("android")
