...
/**
 * Generates DNS verification values from a cryptographically secure random source,
 * prefixed so the record is recognizable (e.g. {@code url-shortener-verify=<hex>}).
 */
@Component
