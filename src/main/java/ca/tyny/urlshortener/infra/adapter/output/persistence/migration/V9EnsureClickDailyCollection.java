...
/**
 * Schema V9: creates the {@code click_daily} rollup collection used for cheap
 * temporal click analytics.
 *
 * <p>A unique compound {@code (shortCode, day)} index guarantees one row per
 * (short code, UTC calendar day) — the rollup job upserts on this key, so
