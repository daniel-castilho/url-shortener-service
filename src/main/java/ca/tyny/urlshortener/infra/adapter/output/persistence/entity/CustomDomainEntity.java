 ...
 *
 * <p>The unique {@code host} index is created by migration V8 (auto-index-creation is
 * disabled; the schema is owned by migrations). The {@link #status} field stores the
 * {@link DomainStatus} enum name.
 */
...
public class CustomDomainEntity {
    ...
    public CustomDomainEntity(String host, String userId, DomainStatus status,
            String verificationToken, Instant createdAt) {
        this.host = host;
        this.userId = userId;
        this.status = status;
