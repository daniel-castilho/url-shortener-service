 ...
 *
 * <ul>
 *   <li>{@code userId} (non-unique, already exists from V3)
 *   <li>{@code (userId, createdAt)} compound non-unique index for cursor pagination
 * </ul>
 *
 * <p>The compound index supports the cursor-based pagination query which orders by {@code createdAt
 * DESC, _id DESC}.
 */
@Component
