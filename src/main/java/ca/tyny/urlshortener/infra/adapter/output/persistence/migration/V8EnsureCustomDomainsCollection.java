...
/**
 * Schema V8: creates the {@code custom_domains} collection used by the branded-domain
 * feature.
 *
 * <ul>
 *   <li>unique index on {@code host} — a host can be claimed only once;</li>
 *   <li>{@code userId} index — owner-scoped listing/delete.</li>
 * </ul>
 *
