...
public class UpdateLinkRequest {
  ...
  @JsonIgnore private final Map<String, Object> suppliedFields = new LinkedHashMap<>();
  ...
  public void setOriginalUrl(String originalUrl) {
    ...
    suppliedFields.put("originalUrl", originalUrl);
  }
  ...
  public void setTitle(String title) {
    this.title = title;
    suppliedFields.put("title", title);
  }
  ...
  public void setTags(List<String> tags) {
    this.tags = tags;
    suppliedFields.put("tags", tags);
  }

  public UtmParamsRequest getUtm() {
    return utm;
  }

  public void setUtm(UtmParamsRequest utm) {
    this.utm = utm;
    suppliedFields.put("utm", utm);
  }
  ...
  public void setExpiresAt(Instant expiresAt) {
    ...
    suppliedFields.put("expiresAt", expiresAt);
  }
  ...
  public void setDomain(String domain) {
    this.domain = domain;
    suppliedFields.put("domain", domain);
  }
