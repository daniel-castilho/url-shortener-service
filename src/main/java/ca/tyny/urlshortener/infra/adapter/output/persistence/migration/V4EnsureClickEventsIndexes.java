...
/**
 * Ensures the {@code click_events} indexes used by analytics aggregates and retention purge: a
 * compound {@code (shortCode, timestamp)} index and a standalone {@code timestamp} index.
...
public class V4EnsureClickEventsIndexes implements SchemaMigration {
  ...
  public void apply(MongoTemplate mongoTemplate) {
    ...
    indexOps.ensureIndex(
        new Index("shortCode", Sort.Direction.ASC).on("timestamp", Sort.Direction.ASC));
