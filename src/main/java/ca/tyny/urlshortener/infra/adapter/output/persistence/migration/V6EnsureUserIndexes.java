 ...
 *
 * <ul>
 *   <li>{@code email} — unique index (registration guard, storage-level uniqueness)
 *   <li>{@code plan} — non-unique index
 *   <li>{@code createdAt} — non-unique index
 * </ul>
 *
 * Mirrors the {@code @Indexed} annotations on {@link
 * ca.tyny.urlshortener.infra.adapter.output.persistence.UserEntity}. Idempotent via {@code
 * ensureIndex}.
 */
@Component
