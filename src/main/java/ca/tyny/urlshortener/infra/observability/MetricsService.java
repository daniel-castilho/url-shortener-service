...
/**
 * Service for tracking custom business metrics using Micrometer. Provides methods to record URL
 * shortening operations, cache performance, and ID generation metrics.
 */
@Component
