 ...
 *
 * <p>Carries the numbers needed to emit standard throttling headers ({@code RateLimit-Remaining},
 * {@code RateLimit-Reset}, {@code Retry-After}).
 *
 * @param allowed whether the request may proceed
 * @param remainingTokens whole tokens left in the bucket after this decision
 * @param resetSeconds when blocked, seconds until one token refills (>= 1); 0 when allowed
 */
