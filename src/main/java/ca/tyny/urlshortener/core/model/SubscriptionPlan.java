 ...
 *
 * <p>Each plan defines: - vanityUrlsPerMonth: Number of custom aliases allowed per month (-1 =
 * unlimited) - minAliasLength: Minimum length for custom aliases - apiCallsPerMonth: API calls
 * quota (-1 = unlimited) - maxCustomDomains: Number of custom domains allowed (-1 = unlimited) -
