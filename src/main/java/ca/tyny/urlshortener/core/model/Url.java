...
/**
 * Value Object representing a URL. Immutable with basic format validation. Comprehensive SSRF and
 * format validation is done by {@link ca.tyny.urlshortener.core.validation.UrlValidator}.
 */
