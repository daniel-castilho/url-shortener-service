...
/**
 * Time-series click statistics for a single short URL, owner-guarded at the
 * use-case layer.
 *
 * @param totalClicks sum across the requested range
 * @param series      ordered buckets (daily or hourly, ascending)
 * @param breakdown   optional dimension (device | country | referrer) to
 *                    value-to-count map for the range, from the click_daily rollup
 */
