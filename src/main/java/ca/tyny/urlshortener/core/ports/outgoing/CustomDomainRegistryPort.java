 ...
 *
 * <p>Only domains in {@link ca.tyny.urlshortener.core.model.DomainStatus#ACTIVE} resolve.
 * This is a cached/cheap lookup on the redirect path — an in-memory snapshot of a Redis
 * set, refreshed periodically — and must never add a slow or blocking call there.
 */
