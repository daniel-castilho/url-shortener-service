...
public interface GetClickAnalyticsUseCase {
     ...
     * @param from   inclusive range start (UTC date); {@code null} defaults to
     *               29 days before {@code to}
     ...
     * @throws IllegalArgumentException for an invalid range (from after to, or
     *                                  hourly range larger than 30 days)
     */
