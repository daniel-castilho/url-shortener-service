...
/**
 * Validates destination URLs for SSRF protection and format compliance. Implementations can enforce
 * HTTPS, block private/internal IPs, check blocklists, etc.
 */
public interface UrlValidator {
  ...
  record ValidationResult(
      boolean allowed, String host, List<java.net.InetAddress> resolvedIps, String reason) {
    ...
    public static ValidationResult blocked(
        String host, List<java.net.InetAddress> ips, String reason) {
