...
/**
 * Pure algorithm for generating random Base62 short codes. Uses {@link java.security.SecureRandom}
 * (CSPRNG) for cryptographic randomness. No framework dependencies — pure Java.
 */
