 ...
 *
 * <p>This strategy is selected when no custom alias is provided (null or blank). It delegates to
 * {@link IdGeneratorPort} which produces cryptographically secure random Base62 codes using {@link
 * java.security.SecureRandom}.
 *
 * <p><b>Collision handling:</b> The strategy relies on the underlying {@link IdGeneratorPort}
 * implementation to handle collisions via bounded retry on unique key constraint violation (see
 * {@link ca.tyny.urlshortener.core.service.UrlShortenerService#saveWithCollisionRetry}).
 *
