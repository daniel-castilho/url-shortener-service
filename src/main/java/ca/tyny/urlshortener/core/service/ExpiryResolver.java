 ...
 *
 * <p>This encapsulates the domain policy: a {@code null} TTL means "never expires", and values
 * exceeding the server-side cap ({@code maxTtlSeconds}) are rejected. The cap is enforced by
 * throwing {@link InvalidExpiryException} which maps to HTTP 400.
 */
