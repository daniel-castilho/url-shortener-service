...
public class GetClickAnalyticsUseCaseImpl implements GetClickAnalyticsUseCase {
  ...
  public GetClickAnalyticsUseCaseImpl(
  ...
  @Override
  public ClicksSeries get(
      String userId, String id, AnalyticsUnit unit, LocalDate from, LocalDate to)
    ...
    List<ClicksSeries.Bucket> series =
        switch (unit) {
