...
/**
 * Thrown when a generated short code collides with an existing _id in the repository. This is
 * distinct from AliasAlreadyExistsException (user-supplied vanity alias conflict).
 */
